...
export interface Printer {
  id: number;
  name: string;
  connection_type: 'bambu' | 'klipper' | 'octoprint' | 'prusalink';  // protocol/transport; defaults to bambu
...
export interface PrinterCreate {
  name: string;
  connection_type?: 'bambu' | 'klipper' | 'octoprint' | 'prusalink';  // defaults to 'bambu' on the backend
