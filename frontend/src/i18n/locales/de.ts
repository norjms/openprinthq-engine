export default {
  ...
  printers: {
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Obico-API-Schlüssel',
      obicoApiKeyHelp: 'Aus den Obico-Kontoeinstellungen (Einstellungen → API-Schlüssel). Erforderlich.',
      obicoPrinterId: 'Obico-Drucker-ID',
      obicoPrinterIdHelp: 'Die ID des Druckers in deinem Obico-Konto (nicht die Bambuddy-ID) – zu finden in der Obico-Druckerliste.',
      hostPort: 'Port',
      apiKeyOptional: 'API-Schlüssel (optional)',
      apiKeyHelp: 'Nur nötig, wenn der Drucker einen API-Schlüssel / ein Token verlangt.',
