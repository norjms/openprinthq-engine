export default {
  ...
  printers: {
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Chiave API Obico',
      obicoApiKeyHelp: 'Dalle impostazioni del tuo account Obico (Impostazioni → Chiavi API). Obbligatoria.',
      obicoPrinterId: 'ID stampante Obico',
      obicoPrinterIdHelp: 'L\'ID della stampante nel tuo account Obico (non l\'ID Bambuddy) — consultabile nell\'elenco stampanti di Obico.',
      hostPort: 'Porta',
      apiKeyOptional: 'Chiave API (opzionale)',
      apiKeyHelp: 'Necessaria solo se la stampante richiede una chiave API o un token.',
