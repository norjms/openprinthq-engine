export default {
  ...
  printers: {
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Clave API de Obico',
      obicoApiKeyHelp: 'Desde la configuración de tu cuenta de Obico (Configuración → Claves API). Obligatorio.',
      obicoPrinterId: 'ID de impresora en Obico',
      obicoPrinterIdHelp: 'El ID de la impresora dentro de tu cuenta de Obico (no el ID de Bambuddy) — búscalo en la lista de impresoras de Obico.',
      hostPort: 'Puerto',
      apiKeyOptional: 'Clave API (opcional)',
      apiKeyHelp: 'Solo es necesario si la impresora requiere una clave API o token.',
