export default {
  ...
  printers: {
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Obico API 金鑰',
      obicoApiKeyHelp: '從你的 Obico 帳戶設定取得（設定 → API 金鑰）。必填。',
      obicoPrinterId: 'Obico 印表機 ID',
      obicoPrinterIdHelp: '此印表機在你的 Obico 帳戶中的 ID（不是 Bambuddy 的 ID）——可在 Obico 印表機清單中查看。',
      hostPort: '連接埠',
      ...
      moonrakerApiKey: 'Moonraker API 金鑰（選用）',
      moonrakerApiKeyPlaceholder: '開放區域網路請留空',
      moonrakerApiKeyHelp: '僅當 Moonraker 需要驗證時才需填寫。開放區域網路可留空。',
      klipperProfile: '印表機設定檔',
      saveChanges: '儲存更改',
    },
    // Skip objects
    skipObjects: {
