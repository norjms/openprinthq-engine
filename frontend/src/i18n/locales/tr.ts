export default {
  ...
  printers: {
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Obico API anahtarı',
      obicoApiKeyHelp: 'Obico hesap ayarlarınızdan alınır (Ayarlar → API anahtarları). Zorunludur.',
      obicoPrinterId: 'Obico yazıcı kimliği',
      obicoPrinterIdHelp: 'Yazıcının Obico hesabınızdaki kimliği (Bambuddy kimliği değil) — Obico yazıcı listesinde bulabilirsiniz.',
