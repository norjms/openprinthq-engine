export default {
  ...
  printers: {
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Obico API 密钥',
      obicoApiKeyHelp: '从你的 Obico 账户设置中获取（设置 → API 密钥）。必填。',
      obicoPrinterId: 'Obico 打印机 ID',
      obicoPrinterIdHelp: '该打印机在你的 Obico 账户中的 ID（不是 Bambuddy 的 ID）——可在 Obico 打印机列表中查看。',
      hostPort: '端口',
