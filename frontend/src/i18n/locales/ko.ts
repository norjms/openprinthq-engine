export default {
  ...
  printers: {
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Obico API 키',
      obicoApiKeyHelp: 'Obico 계정 설정(설정 → API 키)에서 확인합니다. 필수입니다.',
      obicoPrinterId: 'Obico 프린터 ID',
      obicoPrinterIdHelp: 'Bambuddy ID가 아닌, Obico 계정 내 프린터 ID입니다. Obico 프린터 목록에서 확인하세요.',
      hostPort: '포트',
