export default {
  ...
  printers: {
    ...
    // Add/Edit modal
    klipperActions: {
      homing: 'Referenciando todos os eixos…',
      levelling: 'Nivelando o pórtico…',
      eStopSent: 'Parada de emergência enviada',
      homeAll: 'Referenciar todos os eixos',
      quadGantryLevel: 'Nivelamento Quad Gantry',
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Chave de API do Obico',
      obicoApiKeyHelp: 'Nas configurações da sua conta Obico (Configurações → Chaves de API). Obrigatório.',
      obicoPrinterId: 'ID da impressora no Obico',
      obicoPrinterIdHelp: 'O ID da impressora na sua conta Obico (não o ID do Bambuddy) — encontre na lista de impressoras do Obico.',
      hostPort: 'Porta',
      ...
      moonrakerApiKeyPlaceholder: 'Deixe vazio para LAN aberta',
      moonrakerApiKeyHelp: 'Necessário apenas se o Moonraker exigir autenticação. Em LAN aberta, deixe em branco.',
      klipperProfile: 'Perfil da impressora',
