export default {
  ...
  printers: {
    ...
    // Add/Edit modal
    klipperActions: {
      homing: 'Homing all axes…',
      levelling: 'Levelling gantry…',
      eStopSent: 'Emergency stop sent',
      homeAll: 'Home all axes',
      quadGantryLevel: 'Quad gantry level',
    ...
    modal: {
      ...
      typeMks: 'MKS',
      typeObico: 'Obico',
      obicoApiKey: 'Obico API key',
      obicoApiKeyHelp: 'From your Obico account settings (Settings → API keys). Required.',
      obicoPrinterId: 'Obico printer ID',
      obicoPrinterIdHelp: 'The printer\'s ID within your Obico account (not this printer\'s Bambuddy ID) — find it in the Obico printer list.',
      hostPort: 'Port',
      apiKeyOptional: 'API key (optional)',
      apiKeyHelp: 'Only needed if the printer requires an API key / token.',
      ...
      moonrakerApiKeyPlaceholder: 'Leave empty for open LAN',
      moonrakerApiKeyHelp: 'Only needed if Moonraker requires authentication. Open-LAN setups can leave this blank.',
      klipperProfile: 'Printer profile',
